...
class VNPayReturnView(APIView):
    ...
    def get(self, request):
        ...
        if response_code == '00':
            ...
            payment_attempt.status = Payment.Status.SUCCESS
            payment_attempt.vnp_response_code = response_code
            payment_attempt.vnp_transaction_no = input_data.get(
                'vnp_TransactionNo'
            )

            payment_attempt.bank_code = input_data.get(
                'vnp_BankCode'
            )
